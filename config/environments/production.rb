Rails.application.configure do
  ...
  config.action_cable.url = 'wss://167.172.171.91/cable'
  config.action_cable.allowed_request_origins = [ 'http://167.172.171.91/' ]
  ...
  config.action_mailer.default_url_options = { host: '167.172.171.91' }
